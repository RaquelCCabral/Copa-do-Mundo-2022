...
function dataGet() {
    ...
    document.getElementById('golsT1').value = localStorage.getItem('golsT1');
    document.getElementById('golsT2').value = localStorage.getItem('golsT2');
    document.getElementById('penaltisT1').value = localStorage.getItem('penaltisT1');
    document.getElementById('penaltisT2').value = localStorage.getItem('penaltisT2');
